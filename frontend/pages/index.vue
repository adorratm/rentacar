  ...
  <div>
    <section data-anim-wrap class="masthead -type-8">
      <div data-anim-child="fade" class="masthead__bg">
        <img
          src="/frontend/images/masthead/8/bg.png"
          alt="image"
          class="col-12 h-full object-cover"
        />
      </div>
          ...
          <div class="col-xl-10">
            <div class="text-center">
              <h1
                ...
                class="text-60 lg:text-40 md:text-30 text-dark-1"
              >
                Search for the Best Car Hire Deals
              </h1>
              <p data-anim-child="slide-up delay-6" class="text-dark-1 mt-5">
      ...
      <div
        ...
        class="masthead-bottom mt-80 md:mt-40"
      >
        <div
          class="mainSearch -col-5 -w-1070 mx-auto bg-white pr-20 py-20 lg:px-20 lg:pt-5 lg:pb-20 rounded-4 shadow-1"
        >
          <div class="button-grid items-center">
            ...
            <div
              class="searchMenu-date px-30 lg:py-20 lg:px-0 js-form-dd js-calendar"
            >
            ...
            <div class="button-item">
              <button
                class="mainSearch__submit button -dark-1 py-15 px-35 h-60 col-12 rounded-4 bg-dark-1 text-white"
              >
        ...
        <div class="masthead-slider overflow-hidden js-masthead-slider-8">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="/frontend/images/masthead/8/1.png" alt="image" />
            </div>
          ...
          <div class="masthead-slider__nav -prev">
            <button
              class="button -outline-white size-50 flex-center text-white rounded-full js-prev"
            >
          ...
          <div class="masthead-slider__nav -next">
            <button
              class="button -outline-white size-50 flex-center text-white rounded-full js-next"
            >
      ...
      <div data-anim-wrap class="container">
        ...
        <div class="row y-gap-40 justify-between pt-40 sm:pt-20">
          <div data-anim-child="slide-up delay-2" class="col-lg-4 col-sm-6">
            <div
              class="featureIcon -type-1 -hover-shadow px-50 py-50 lg:px-24 lg:py-15"
            >
              <div class="d-flex justify-center">
                <img
                  src="#"
                  data-src="/frontend/images/featureIcons/2/1.svg"
                  alt="image"
                  class="js-lazy"
                />
              </div>
          ...
          <div data-anim-child="slide-up delay-3" class="col-lg-4 col-sm-6">
            ...
            >
              <div class="d-flex justify-center">
                <img
                  src="#"
                  data-src="/frontend/images/featureIcons/2/2.svg"
                  alt="image"
                  class="js-lazy"
                />
              </div>
          ...
          <div data-anim-child="slide-up delay-4" class="col-lg-4 col-sm-6">
            ...
            >
              <div class="d-flex justify-center">
                <img
                  src="#"
                  data-src="/frontend/images/featureIcons/2/3.svg"
                  alt="image"
                  class="js-lazy"
                />
              </div>
    ...
    <section class="layout-pt-md layout-pb-md">
      <div data-anim-wrap class="container">
        ...
        >
          <div class="swiper-wrapper">
            <div data-anim-child="slide-up delay-2" class="swiper-slide">
              <a
                ...
                class="carCard -type-1 d-block rounded-4"
              >
                  ...
                  <div class="cardImage ratio border-light ratio-6:5">
                    <div class="cardImage__content">
                      <img
                        ...
                        src="/frontend/images/cars/1.png"
                        alt="image"
                      />
                    </div>
                ...
                <div class="carCard__content mt-10">
                  <div class="d-flex items-center lh-14 mb-5">
                    ...
                    <div
                      class="size-3 bg-light-1 rounded-full ml-10 mr-10"
                    ></div>
                  ...
                  <h4 class="text-dark-1 text-18 lh-16 fw-500">
                    ...
                    <span class="text-15 text-light-1 fw-400">or similar</span>
                  </h4>
                  ...
                  <div class="d-flex items-center mt-20">
                    <div
                      class="flex-center bg-yellow-1 rounded-4 size-30 text-12 fw-600 text-dark-1"
                    >
                      4.8
                    </div>
                      ...
                      >
                        <div class="swiper-wrapper">
                          <div class="swiper-slide">
                            <img
                              class="col-12"
                              src="/frontend/images/cars/2.png"
                              alt="image"
                            />
                          </div>
                          ...
                          <div class="swiper-slide">
                            <img
                              class="col-12"
                              src="/frontend/images/cars/3.png"
                              alt="image"
                            />
                          </div>
                ...
                <div class="carCard__image">
                  <div class="cardImage ratio border-light ratio-6:5">
                    <div class="cardImage__content">
                      <img
                        class="rounded-4 col-12"
                        src="/frontend/images/cars/4.png"
                        alt="image"
                      />
                    </div>
          ...
          <div
            class="d-flex x-gap-15 items-center justify-center pt-40 sm:pt-20"
          >
            <div class="col-auto">
              <button
                class="d-flex items-center text-24 arrow-left-hover js-hotels-prev"
              >
            ...
            <div class="col-auto">
              <button
                class="d-flex items-center text-24 arrow-right-hover js-hotels-next"
              >
    ...
    <section class="layout-pt-md layout-pb-lg">
      <div data-anim-wrap class="container">
        ...
        >
          <div class="col-auto">
            <div class="sectionTitle -md">
              <h2 class="sectionTitle__title">Top Destinations in UK</h2>
              <p class="sectionTitle__text mt-5 sm:mt-0">
                These popular destinations have a lot to offer
              </p>
            </div>
        ...
        <div class="row y-gap-30 pt-40">
          <div
            ...
            class="col-xl-2 col-lg-3 col-sm-6"
          >
            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img
                  class="object-cover js-lazy"
                  src="#"
                  data-src="/frontend/images/destinations/5/1.png"
                  alt="image"
                />
              </div>
              ...
              <div class="citiesCard__content mt-10">
                ...
                <div class="text-14 text-light-1">From US$29.52 per day</div>
              </div>
            </a>
          </div>
            ...
            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img
                  class="object-cover js-lazy"
                  src="#"
                  data-src="/frontend/images/destinations/5/2.png"
                  alt="image"
                />
              </div>
            ...
            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img
                  class="object-cover js-lazy"
                  src="#"
                  data-src="/frontend/images/destinations/5/3.png"
                  alt="image"
                />
              </div>
            ...
            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img
                  class="object-cover js-lazy"
                  src="#"
                  data-src="/frontend/images/destinations/5/4.png"
                  alt="image"
                />
              </div>
            ...
            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img
                  class="object-cover js-lazy"
                  src="#"
                  data-src="/frontend/images/destinations/5/5.png"
                  alt="image"
                />
              </div>
            ...
            <a href="#" class="citiesCard -type-4 d-block text-center">
              <div class="citiesCard__image size-160 rounded-full mx-auto">
                <img
                  class="object-cover js-lazy"
                  src="#"
                  data-src="/frontend/images/destinations/5/6.png"
                  alt="image"
                />
              </div>
    ...
    <section class="layout-pt-lg layout-pb-lg bg-dark-1">
      <div data-anim-wrap class="container">
        ...
        <div
          data-anim-child="slide-up delay-2"
          class="overflow-hidden pt-60 lg:pt-40 sm:pt-30 js-section-slider"
          data-gap="30"
        ...
        >
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div
                class="testimonials -type-1 bg-white rounded-4 pt-40 pb-30 px-40"
              >
                ...
                <p class="testimonials__text lh-18 fw-500 text-dark-1">
                  ...
                  in Japan with our luggage - the location for this hotel made
                  that so easy. Agoda price was fantastic.&quot;
                </p>
                ...
                <div class="pt-20 mt-28 border-top-light">
                  <div class="row x-gap-20 y-gap-20 items-center">
                    <div class="col-auto">
                      <img
                        class="size-60"
                        src="/frontend/images/avatars/1.png"
                        alt="image"
                      />
                    </div>
        ...
        <div
          data-anim-child="slide-up delay-3"
          class="row y-gap-40 items-center pt-40 sm:pt-20"
        >
          <div class="col-xl-4">
            <div class="row y-gap-30 text-white sm:text-center">
              ...
              <div class="col-sm-5 col-6">
                ...
                <div
                  class="d-flex x-gap-5 items-center sm:justify-center pt-10"
                >
          ...
          <div class="col-xl-8">
            <div class="row y-gap-30 justify-between items-center">
              <div class="col-md-auto col-6">
                <div class="d-flex justify-center">
                  <img src="/frontend/images/clients/1.svg" alt="image" />
                </div>
              </div>

              <div class="col-md-auto col-6">
                <div class="d-flex justify-center">
                  <img src="/frontend/images/clients/2.svg" alt="image" />
                </div>
              </div>

              <div class="col-md-auto col-6">
                <div class="d-flex justify-center">
                  <img src="/frontend/images/clients/3.svg" alt="image" />
                </div>
              </div>

              <div class="col-md-auto col-6">
                <div class="d-flex justify-center">
                  <img src="/frontend/images/clients/4.svg" alt="image" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row y-gap-30 justify-between items-center">
          <div class="col-xl-5 col-lg-6">
            ...
            <div class="d-inline-block mt-40 lg:mt-20">
              <a href="#" class="button -md -blue-1 bg-dark-1 text-white">
                Learn More
              ...
              <div class="blogCard__image">
                <div class="ratio ratio-4:3 rounded-4 rounded-8">
                  <img
                    ...
                    src="#"
                    data-src="/frontend/images/blog/1.png"
                    alt="image"
                  />
                </div>
              </div>
              ...
              <div class="blogCard__image">
                <div class="ratio ratio-4:3 rounded-4 rounded-8">
                  <img
                    class="img-ratio js-lazy"
                    src="#"
                    data-src="/frontend/images/blog/2.png"
                    alt="image"
                  />
                </div>
              </div>
            ...
            <div class="row y-gap-30">
              ...
              >
                <a
                  ...
                  class="blogCard -type-1 d-flex items-center"
                >
                  <div class="blogCard__image size-130 rounded-8">
                    <img
                      src="/frontend/images/blog/1.png"
                      alt="image"
                  ...
                  <div class="ml-24">
                    <h4 class="text-18 lh-14 fw-500 text-dark-1">
    ...
    <section data-anim-wrap class="section-bg pt-80 pb-80 md:pt-40 md:pb-40">
      <div
        data-anim-child="fade delay-1"
        class="section-bg__item -w-1500 rounded-4 bg-yellow-1"
      ></div>
      ...
      <div class="container">
        <div class="row y-gap-30 items-center justify-between">
          <div data-anim-child="slide-up delay-2" class="col-xl-5 col-lg-6">
            ...
            <p class="text-dark-1 pr-40 lg:pr-0 mt-15 sm:mt-5">
          ...
          <div data-anim-child="slide-up delay-3" class="col-lg-6">
            <img src="/frontend/images/app/1.png" alt="image" />
          </div>
        </div>
      </div>
    </section>
