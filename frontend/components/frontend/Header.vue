<template>
  <div>
    ...
    >
      <div
        data-anim="fade"
        class="header__container header__container-1500 mx-auto px-30 sm:px-20"
      >
        <div class="row justify-between items-center">
          <div class="col-auto">
            <div class="d-flex items-center">
              <a
                href="index-2.html"
                class="header-logo mr-50"
                data-x="header-logo"
                data-x-toggle="is-logo-dark"
              >
                <img src="/frontend/images/general/logo-dark-2.svg" alt="logo icon" />
                <img src="/frontend/images/general/logo-dark-2.svg" alt="logo icon" />
              </a>
                    ...
                    <ul class="menu__nav text-dark-1 fw-500 -is-active">
                      <li class="menu-item-has-children">
                        ...
                        <ul class="subnav">
                          <li class="subnav__backBtn js-nav-list-back">
                            <a href="#"
                              ><i class="icon icon-chevron-sm-down"></i> Home</a
                            >
                          </li>
                            ...
                            <div class="tabs__content js-tabs-content">
                              ...
                              >
                                <div class="mega__content">
                                  ...
                                  <div class="mega__image d-flex relative">
                                    <img
                                      src="#"
                                      data-src="/frontend/images/backgrounds/7.png"
                                      alt="image"
                              ...
                              <div class="tabs__pane -tab-item-2">
                                <div class="mega__content">
                                  ...
                                  <div class="mega__image d-flex relative">
                                    <img
                                      src="/frontend/images/backgrounds/7.png"
                                      alt="image"
                                      class="rounded-4"
                                    />
                      ...
                      <li class="menu-item-has-children">
                        ...
                        <ul class="subnav">
                          <li class="subnav__backBtn js-nav-list-back">
                            <a href="#"
                              ><i class="icon icon-chevron-sm-down"></i> Blog</a
                            >
                          </li>
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              <div class="mr-15 xxl:d-none">
                <button class="text-26 text-dark-1">
              ...
              >
                <a
                  href="login.html"
                  class="button px-30 fw-400 text-14 -blue-1 bg-dark-1 h-50 text-white"
                  >Become An Expert</a
                >
                <a
                  href="signup.html"
                  class="button px-30 fw-400 text-14 border-dark-1 -blue-1 h-50 text-dark-1 ml-20"
                  >Sign In / Register</a
                >
              </div>

              <div
                class="d-none xl:d-flex x-gap-20 items-center pl-30"
